...
class LinearEq2var(AbstractAnim):
    ...
    def Terms(self):
        ...
        self.isRandom = False
        p10=cvo.CVO().CreateCVO("ax+by=c","").setPosition([-3,0,0])
        p11=cvo.CVO().CreateCVO("Variable term1","ax").setPosition([3,2,0])
        p12=cvo.CVO().CreateCVO("Variable term2","by").setPosition([4,0,0])
        p13=cvo.CVO().CreateCVO("Constant term", "c").setPosition([3,-2.5,0])
    ...
    def SetSourceCodeFileName(self):
        self.SourceCodeFileName="Grade9Chapter6LinearEq2var.py"
