...
class ConstructionsChapter(AbstractAnim):
    def construct(self):
    ...
    def SetSourceCodeFileName(self):
        self.SourceCodeFileName = "Grade9Chapter13GeometricConstructions.py"
    ...
    def AngleBisector(self):
        ...
        ray_bf_start = point_b.get_center() + (dot_f.get_center() - point_b.get_center()) * -0.1  # Slightly adjust start
        ray_bf_end = point_b.get_center() + 2 * (dot_f.get_center() - point_b.get_center())  # Ensure proper length
        ray_bf = Arrow(start=ray_bf_start, end=ray_bf_end, color=ORANGE, stroke_width=4)
    ...
    def Create60DegreeAngle(self):
     ...
     # Choose one of the intersections or adjust based on your needs
    ...
    def ConstructTriangle3(self):
        ...
        step4_text = Text("Step 4: Mark a point C on the arc of the circle\n""Join AC and BC.", font_size=24).shift(LEFT*3.6 + DOWN*2)
...
def BBAS2(self):
        ...
        p11=cvo.CVO().CreateCVO("Given base, Base angle, \\\\Sum of 2 sides","").setPosition([4,0,0]).setangle(-TAU/4)
        p11.setcircleradius(2)
        p10.setcircleradius(1.5)
        p10.cvolist.append(p11)
        self.construct1(p10,p10)
...
def BBAD2(self):
        self.isRandom = False
        p10=cvo.CVO().CreateCVO("Construction of Triangles","").setPosition([-4,0,0]).setangle(-TAU/4)
        p11=cvo.CVO().CreateCVO("Given base, Base angle, \\\\Difference of 2 sides","").setPosition([4,0,0]).setangle(-TAU/4)
        p11.setcircleradius(2)
        p11.setcircleradius(2)
        p10.setcircleradius(1.5)
        p10.cvolist.append(p11)
...
def ChordTriangle(self):
        self.isRandom = False
        p10=cvo.CVO().CreateCVO("Construction of Triangles","").setPosition([-4,0,0]).setangle(-TAU/4)
        p11=cvo.CVO().CreateCVO("Cirlce segement\\\\for given chord and angle","").setPosition([-4,0,0]).setangle(-TAU/4)
        p11.setcircleradius(2)
        p11.setcircleradius(2)
        p10.setcircleradius(1.5)
        p10.cvolist.append(p11)
