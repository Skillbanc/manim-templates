...
class Grade1Chapter17LengthWeightSize(AbstractAnim):
    ...
    def topic3(self):
        ...
        p13=cvo.CVO().CreateCVO("Hand-span", "between the little finger ,thumb of hand").setPosition([-4,2,0])
        p14=cvo.CVO().CreateCVO("Cubit", "between the elbow ,tip of the fingers").setPosition([-4,0,0])
        p15=cvo.CVO().CreateCVO("Foot", "between the sole ,the toes").setPosition([-4,-2,0])
        p10.cvolist.append(p11)
