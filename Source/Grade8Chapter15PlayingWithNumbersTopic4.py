...
class Grade8Chapter15PlayingWithNumbersTopic4(AbstractAnim):
    ...
    def SetSourceCodeFileName(self):
       self.SourceCodeFileName="Grade8Chapter15PlayingWithNumbersTopic4.py"


if __name__ == "__main__":
    scene = Grade8Chapter15PlayingWithNumbersTopic4()
    scene.render()