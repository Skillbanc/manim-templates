...
class Money(AbstractAnim):
    ...
    def SetSourceCodeFileName(self):
        self.SourceCodeFileName="Grade2Chapter17Money.py"

    def Introduce_currency(self):
        self.angleChoice=[TAU/4,TAU/4]
        p10=cvo.CVO().CreateCVO("Currency","").setPosition([-3,0,0])
        p11=cvo.CVO().CreateCVO("Coins","").setPosition([2,2,0])
        p12=cvo.CVO().CreateCVO("Notes","").setPosition([2,-2,0])
    ...
    def Display_currency_relationships(self):
        ...
        self.play(FadeIn(equation_1[0]), FadeIn(equation_1[1]))  # Display left side and equals sign
        self.wait(1)
        self.play(FadeIn(equation_1[2]))  # Display right side
        self.wait(2)
        ...
        self.play(FadeIn(equation_2_1[0]), FadeIn(equation_2_1[1]))  # Display left side and equals sign
        self.wait(1)
        self.play(FadeIn(equation_2_1[2]))  # Display right side
        self.wait(2)
        self.play(FadeIn(equation_2_2[0]), FadeIn(equation_2_2[1]))  # Display left side and equals sign
        self.wait(1)
        self.play(FadeIn(equation_2_2[2]))  # Display right side
        self.wait(2)
        self.play(FadeIn(equation_2_3[0]), FadeIn(equation_2_3[1]))  # Display left side and equals sign
        self.wait(1)
        self.play(FadeIn(equation_2_3[2]))  # Display right side
        self.wait(2)
        ...
        # Display equation
        self.play(FadeIn(equation3[0]),FadeIn(equation3[1]))
        self.wait(2)
        self.play(FadeIn(equation3[2]))
        self.wait(2)
        ...
        self.play(FadeIn(equation_4[0]), FadeIn(equation_4[1]))  # Display left side and equals sign
        self.wait(1)
        self.play(FadeIn(equation_4[2]))  # Display right side
        self.wait(2)
        ...
        self.play(FadeIn(equation_5[0]), FadeIn(equation_5[1]))  # Display left side and equals sign
        self.wait(1)
        self.play(FadeIn(equation_5[2]))  # Display right side
        self.wait(2)
        ...
        self.play(FadeIn(equation_6[0]), FadeIn(equation_6[1]))  # Display left side and equals sign
        self.wait(1)
        self.play(FadeIn(equation_6[2]))  # Display right side
        self.wait(2)
        ...
        self.play(FadeIn(equation_7[0]), FadeIn(equation_7[1]))  # Display left side and equals sign
        self.wait(1)
        self.play(FadeIn(equation_7[2]))  # Display right side
        self.wait(2)
        self.play(FadeOut(equation_7))


    def create_equation(self, high_val, low_vals, use_circle=False):
        shape = Circle(radius=0.6, color="#C0C0C0", fill_opacity=0.8) if use_circle else Rectangle(height=0.8, width=1.5, color=BLUE, fill_opacity=0.8)
    ...
    def Combinations(self):
        ...
        eq_1.shift(UP * 1)
        self.play(FadeIn(eq_1[0]), FadeIn(eq_1[1]))  # Display left side and equals sign
        self.wait(1)
        self.play(FadeIn(eq_1[2]))  # Display right side
        self.wait(2)

        # Example 2: ₹2 + ₹2 + ₹1 = ₹5
        eq_2 = self.combined_equation(["₹2", "₹5", "₹1"], 8)
        eq_2.shift(DOWN * 1)
        self.play(FadeIn(eq_2[0]), FadeIn(eq_2[1]))  # Display left side and equals sign
        self.wait(1)
        self.play(FadeIn(eq_2[2]))  # Display right side
        self.wait(2)
