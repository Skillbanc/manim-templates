...
class test1(AbstractAnim):
    ...
    def Introduction(self):
        ...
        p10=cvo.CVO().CreateCVO("Example Number 1","5").setPosition([0,2.5,0])
        ...
        p14=cvo.CVO().CreateCVO("Number Between 5 and 7","6").setPosition([-4,0,0]).setangle(-TAU/4)
        ...
        self.play(Create(CurvedArrow(p10.pos,p14.pos)),Create(CurvedArrow(p11.pos,p14.pos)))
        self.fadeOutCurrentScene()
    ...
    def SetSourceCodeFileName(self):
        self.SourceCodeFileName = "test1.py"
