...
class DivisibilityRules3(AbstractAnim):
    ...
    def DivisibilityRule12(self):
        ...
        p12=cvo.CVO().CreateCVO("last 2 digits","24").setPosition([5,-2,0])
        p13=cvo.CVO().CreateCVO("Divisibility Rule of 4", "satisfied").setPosition([-4,3,0]).setangle(-TAU/4)
        p14=cvo.CVO().CreateCVO("sum of digits ","6").setPosition([-4,1,0]).setangle(-TAU/4)
        p15=cvo.CVO().CreateCVO("Divisibility Rule of 3", "satisfied").setPosition([-4,-1,0]).setangle(-TAU/4)
        p16=cvo.CVO().CreateCVO("Divisibility Rule of 12", "satisfied").setPosition([-4,-3,0]).setangle(-TAU/4)
        p10.cvolist.append(p11)
