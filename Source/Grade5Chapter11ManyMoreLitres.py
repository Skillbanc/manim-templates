...
class Litres(AbstractAnim):
    ...
    def Qustion(self):
        texta = Text("Question and Answers", color=YELLOW).scale(0.7)
        text2 =Text("(a).How many litres of paint did Amar buy in all?",color=GREEN).scale(0.6) 
        ...
        table_with_lines = VGroup( h_lines, v_lines, extra_h_line_top)
        table_with_lines.center()
        table_with_lines.shift(UP )
        table_with_lines.scale(0.6)
    ...
    def Qustion3(self):
        text2 =Text("(c).How much would one 100 ml can of red paint cost? \n       How much money did Amar spend on red paint?",color=GREEN).scale(0.6)
    ...
    def Qustion4(self):
        text2 =Text("(d).How much would one 100 ml can of yellow paint cost? \n       How much money did Amar spend on yellow paint?",color=GREEN).scale(0.6)
    ...
    def Qustion5 (self):
        text2 =Text("(e).How much would one 100 ml can of white paint cost? \n       How much money did Amar spend on white paint?",color=GREEN).scale(0.6)
    ...
    def Qustion6(self):
        text2 =Text("(f). What is the total amount that Amar spent on paint?",color=GREEN).scale(0.6)
