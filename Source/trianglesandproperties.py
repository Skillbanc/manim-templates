...
# render using CVO data object
    def constructDataByCVO(self):
        p10=cvo.CVO().CreateCVO("triangles","properties")
        p11=cvo.CVO().CreateCVO("sides","PQ,QR,RP")
        p12=cvo.CVO().CreateCVO("angles","angle Q,angle p,angle R")
        p13=cvo.CVO().CreateCVO("vertices","p,q,r")
