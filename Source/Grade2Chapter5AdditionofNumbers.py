...
class AdditionofNumbers(AbstractAnim):
    ...
    def addition(self):
        ...
        p10=cvo.CVO().CreateCVO("Addition","").setPosition([-4.5,1,0])
        p11=cvo.CVO().CreateCVO("definition","Addition is the process of combining numbers to find their total.").setPosition([1.5,2,0]).setangle(-TAU/4)
        p12=cvo.CVO().CreateCVO("Symbol","+").setPosition([3.5,0,0])
        p13=cvo.CVO().CreateCVO("Example","35+15=50").setPosition([-2,-2.5,0])
