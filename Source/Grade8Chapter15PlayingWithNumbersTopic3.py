...
class Grade8Chapter15PlayingWithNumbersTopic3(AbstractAnim):
    ...
    def create_animation(self):
         self.isRandom = False
         self.angleChoice = [-TAU/4,TAU/4,-TAU/2,-TAU/2,-TAU/2,TAU/4,TAU/4]
        #  p1=cvo.CVO().CreateCVO("o1name","o2name","c1name","c2name")
         ...
         p15=cvo.CVO().CreateCVO("Defination","having 1 and itself as factors").setPosition([-4,0,0])
         p16=cvo.CVO().CreateCVO("Defination","having factors other than 1 or itself").setPosition([4,0,0])
