...
class ConstructionofTriangle(AbstractAnim):
    ...
    def threes(self):
        ...
        text=Text("Construction",font_size=28).to_edge(RIGHT)
        text.add(Underline(text, buff=0.1))
        self.play(Write(text))
        text1=Text("(1)Take a linesegment AB=3",font_size=24).next_to(text,DOWN)
        text2=Text("(2)From A draw an arc of radius 4cm",font_size=24).next_to(text1,DOWN)
        text3=Text("(3)From B draw an arc of radius 2cm",font_size=24).next_to(text2,DOWN)
        text6=Text("(4)Mark the intersection point as C",font_size=24).next_to(text3,DOWN)
        text4=Text("(5)From Intersection draw lines CA and CB",font_size=24).next_to(text6,DOWN)
        text5=Text("(6)Triangle is Constructed",font_size=24).next_to(text4,DOWN)
        text.shift(LEFT*3)
        text1.shift(LEFT*3)
    ...
    def twosonea(self):
        ...
        text.add(Underline(text,buff=0.1))
        self.play(Write(text))
        text1=Text("(1)Take a line segment AB=4cm",font_size=24).next_to(text,DOWN)
        text2=Text("(2)From B draw a 50*degree ray",font_size=24).next_to(text1,DOWN)
        text3=Text("(3)Then From B draw an arc with 5cm and mark it C",font_size=24).next_to(text2,DOWN)
        text4=Text("(4)Combine CA",font_size=24).next_to(text3,DOWN)
        text5=Text("(5)Triangle is Constructed",font_size=24).next_to(text4,DOWN)
        text.shift(LEFT*1.5)
        text1.shift(LEFT*1.5)
        text2.shift(LEFT*2.5)
        text3.shift(LEFT*2.5)
        ...
        line_to_start = Line(dot.get_center(), [-5, -2, 0])
        line_to_end = Line(dot.get_center(), [-2, -2, 0], buff=0, stroke_width=4)
        line_to_end.add_tip(tip_length=0.2, at_start=True)
    ...
    def onestwoa(self):
        ...
        text2=Text("(2)Draw a ray taking 45*Degrees from A",font_size=24).next_to(text1,DOWN)
        text3=Text("(3)Draw a ray taking 30*Degrees from B",font_size=24).next_to(text2,DOWN)
        text4=Text("(4)Mark the Intersection of two rays as C",font_size=24).next_to(text3,DOWN)
        # text5=Text("(5)Combine AC and BC",font_size=24).next_to(text4,DOWN)
        text6=Text("(5)Triangle is Constructed",font_size=24).next_to(text4,DOWN)
        text.shift(UP + LEFT*3)
        text1.shift(UP + LEFT*3)
        text2.shift(UP + LEFT*3)
        text3.shift(UP + LEFT*3)
        ...
        line_to_start = Line(dot.get_center(), [-5, -2, 0],buff=0,stroke_width=4)
        line_to_start.add_tip(tip_length=0.2, at_start=True)
        line_to_end = Line(dot.get_center(), [-2, -2, 0], buff=0, stroke_width=4)
        line_to_end.add_tip(tip_length=0.2, at_start=True)
        ...
        angle1_label = MathTex(r"30^\circ").move_to(triangle1.get_vertices()[1] + 0.6 * LEFT + 0.4 * UP)
    ...
    def oneratwos(self):
        ...
        text2=Text("(2)Draw a ray perpendicular to AB",font_size=24).next_to(text1,DOWN)
        text3=Text("(3)Draw an arc taking 11cm from B to intersect ray",font_size=24).next_to(text2,DOWN)
        text4=Text("(4)Mark the intersection point as C.",font_size=24).next_to(text3,DOWN)
        text5=Text("(5)Triangle is Constructed",font_size=24).next_to(text4,DOWN)
        text.shift(LEFT*3)
        text1.shift(LEFT*3)
        text2.shift(LEFT*3)
