...
class ProofsInMath(AbstractAnim):
    ...
    def constructDataByCVO(self):
        p10=cvo.CVO().CreateCVO("Statements","Mathematical Statements").setPosition([-3.5,0,0])
    ...
    def Reasoning(self):
        p13=cvo.CVO().CreateCVO("Reasoning","").setPosition([-3.5,0,0])
        p14=cvo.CVO().CreateCVO("Deductive Reasoning\\\\in Hypothesis testing ","").setPosition([0,2.5,0]).setangle([-TAU/4])
        p15=cvo.CVO().CreateCVO("Deductive Reasoning","").setPosition([0,-2.5,0]).setangle([-TAU/4])
        p16=cvo.CVO().CreateCVO("Definition"," proof is a logical deduction from a set of inputs.").setPosition([3.5,2.5,0]).setangle([-TAU/4])
        p17=cvo.CVO().CreateCVO("Definition","Results from previous statements using logic").setPosition([3.5,-2.5,0]).setangle([-TAU/4])
    ...
    def Types(self):
        p16=cvo.CVO().CreateCVO("Mathematical Statements","").setPosition([-3.5,0,0])
        p17=cvo.CVO().CreateCVO("Theorems","Whose truth is established").setPosition([0,-2.5,0]).setangle([-TAU/4])
        p18=cvo.CVO().CreateCVO("Conjectures","Which we believe is true").setPosition([0,2.5,0]).setangle([-TAU/4])
        p19=cvo.CVO().CreateCVO("Inductive reasoning","based on examining various cases").setPosition([3.5,2.5,0]).setangle([-TAU/4])
        p20=cvo.CVO().CreateCVO("Axioms","Self evident truths").setPosition([3.5,-2.5,0]).setangle([-TAU/4])
    ...
    def Proofs(self):
        ...
        p14=cvo.CVO().CreateCVO("Negation","").setPosition([-3.5,-2,0]).setangle([-TAU/4])
