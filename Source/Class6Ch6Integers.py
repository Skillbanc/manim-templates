...
class int6(AbstractAnim):
    ...
    def RenderAboutMe(self):
        count = 0
        # starting object
        p10=cvo.CVO().CreateCVO("Integers","").setPosition([0,2.5,0])
        count += 1

        p12=cvo.CVO().CreateCVO("Positive Numbers","1,4,6").setPosition([-3,0,0])
        count += 1

        p10.cvolist.append(p12)

        p20=cvo.CVO().CreateCVO("Zero","0,0").setPosition([3,0,0])
        count += 1
        p10.cvolist.append(p20)

        p21=cvo.CVO().CreateCVO("Negitive Number","-1,-4").setPosition([0,0,0])
        count += 1
    ...
    def addnumline(self,):
        ...
        self.play(Create(arrow_a), Create(dot_b), Write(label_b), Write(add_text_a))
        self.wait(1)
        self.play(Write(step_text_b))
        self.play(Create(arrow_b), Create(dot_c), Write(label_c), Write(add_text_b))
        self.wait(1)
