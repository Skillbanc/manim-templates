...
class Class6Chap143DShapesAnim(AbstractAnim,ThreeDScene):
    ...
    def SetSourceCodeFileName(self):
        self.SourceCodeFileName = "Class6Chap143DShapesAnim.py"  
...
if __name__ == "__main__":
    scene = Class6Chap143DShapesAnim()
    scene.render()