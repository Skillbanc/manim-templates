...
class Grade2Chapter13LengthofThings(AbstractAnim):
    ...
    def topic2(self):
        self.isRandom = False
        self.angleChoice = [TAU/4,-TAU/2,-TAU/2,TAU/2]
    ...
    def topic5(self):
        ...
        p13=cvo.CVO().CreateCVO("Hand-span", "between the little finger and thumb of hand").setPosition([-4,2,0])
        p14=cvo.CVO().CreateCVO("Cubit", "between the elbow and tip of the fingers").setPosition([-4,0,0])
        p15=cvo.CVO().CreateCVO("Foot", "between the sole and the toes").setPosition([-4,-2,0])
        p10.cvolist.append(p11)
