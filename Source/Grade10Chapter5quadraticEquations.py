...
# render using CVO data object
    ...
    def quad111(self):
        ...
        p25 = cvo.CVO().CreateCVO("formula to find the roots", "$x = \\frac{-b \\pm \\sqrt{b^2 - 4ac}}{2a}$").setPosition([4, -2, 0]).setangle(-TAU / 4)
...
# manim -pql circle_diagram.py CircleDiagram
    ...
    def quad1155(self):
        ...
        explanation_text = Text("The middle term ‘-5x’ can be written as +6x -x", font_size=24)
        ...
        step5_group.shift(LEFT * 0.5)  # Move slightly to the left
