...
class secantsandtangents(AbstractAnim):
    ...
    def length(self):
        ...
        m10=cvo.CVO().CreateCVO("Finding Tangent Length","")
        m11=cvo.CVO().CreateCVO("Info","")
        m11onnamelist=["Radius-3cm","Hypotenuse side-5cm","Use Pythagorus theorem","length will be found"]
        m10.cvolist.append(m11)
        m11.extendOname(m11onnamelist)
        m11.setcircleradius(2)
        self.construct1(m10,m10)
    ...
    def SetSourceCodeFileName(self):
       self.SourceCodeFileName="Secants and Tangents"
