...
class constructionofquadrilateral8thgrade(AbstractAnim):
    ...
    def toq(self):
        ...
        p13=cvo.CVO().CreateCVO("Rhombus", "").setPosition([-4,3,0])
        p14=cvo.CVO().CreateCVO("Kite", "").setPosition([-4,1,0])
        p15=cvo.CVO().CreateCVO("Rectangle", "").setPosition([-4,-1,0])
        p16=cvo.CVO().CreateCVO("Square", "").setPosition([-4,-3,0])
        p10.cvolist.append(p11)
        p10.cvolist.append(p12)
        p10.cvolist.append(p13)
    ...
    def coq2(self):
        ...
        p11=cvo.CVO().CreateCVO("4 side, angles", "").setPosition([4,2,0])
        p12=cvo.CVO().CreateCVO("4 side, 1 diagonal", "").setPosition([5,-2,0])
        p13=cvo.CVO().CreateCVO("3 side, 2 diagonal", " ").setPosition([-4,2,0])
        p14=cvo.CVO().CreateCVO("2 adjacent, 3 angles", "").setPosition([-4,0,0])
        p15=cvo.CVO().CreateCVO("3 side, 2angle", "").setPosition([-4,-2,0])
        p10.cvolist.append(p11)
        p10.cvolist.append(p12)
        p10.cvolist.append(p13)
        p10.cvolist.append(p14)
